...
OUTPUT_IMG_DIR = os.path.join('data', 'raw', 'good', 'images')
OUTPUT_LBL_DIR = os.path.join('data', 'raw', 'good', 'lables')
...
def extract_frames_by_time():
    ...
    for video_path in video_files:
        ...
        while True:
            ...
            # Save image
            img_filename = f"good_{current_id}.jpg"
